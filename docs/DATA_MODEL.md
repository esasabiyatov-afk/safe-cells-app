...
Документ задаёт логическую схему. Точный SQL будет реализован и протестирован на этапе 1. Имена полей денежного типа используют суффикс `_minor` — целые минимальные единицы валюты; масштаб будет определён после ответа Q-001.
...
| `deposit_refund_minor` | После ответа Q-003. |
...
- Денежная конфигурация не активируется до ответа Q-001.
