...
| ТЗ 12, 15, D-052–D-054 | Отдельная вкладка общего журнала с ФИО и XLSX-выпиской | `services/journal.py`, `services/journal_reports.py`, `routes/journal.py`, `templates/journal.html`, `static/js/journal.js` | Этап 11.5; новая вкладка, активный/архивный клиент, исключение исправлений и секретных реквизитов, фильтры/пагинация/XLSX/API/browser |
